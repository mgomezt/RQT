...
class Resultado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idsorteo, posicion', 'required'),
			array('idsorteo, posicion, resultado', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, idsorteo, posicion, resultado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idsorteo',$this->idsorteo);
